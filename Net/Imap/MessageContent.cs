...
namespace Communications.Net.Imap
{
    public class MessageContent : CommandProcessor
    {
        ...
        private static readonly Regex CommandEndRex = new Regex(@"IMAP\d+ OK");
        ...
        public bool Downloaded
        {
            get
            {
                return _fetchProgress.HasFlag(MessageFetchState.Headers | MessageFetchState.Body);
            }
        }
        ...
        public bool Download()
        {
            ...
            bool result = _client.SendAndReceive(string.Format(ImapCommands.Fetch, _message.UId, string.Format("BODY.PEEK[{0}.MIME] BODY.PEEK[{0}]", ContentNumber)), ref data, this, encoding);
